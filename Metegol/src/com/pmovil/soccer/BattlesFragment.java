...
public class BattlesFragment extends FragmentBase {

    private static final String TAG = "BattlesFragment";
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.battles_fragment, container, false);
        webView = (WebView) view.findViewById(R.id.webview);
        progressBarLay = (RelativeLayout) view
                .findViewById(R.id.progressbarlay);
        pb = (ProgressBar) view.findViewById(R.id.progressbar);
        ivClose = (ImageView) view.findViewById(R.id.iv_battles_fragment_close);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (act != null && act instanceof MainActivity) {
            ((MainActivity) act).prepareBattle();
            ;
        }
        ...
        webView.loadUrl(com.pmovil.soccer.net.ConnectionsWSMetegol.getUrlbattles(getActivity()));
